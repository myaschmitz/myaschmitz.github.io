        ...
        <div className="section-container" style={{ color: 'var(--light-font-color)', background: 'var(--color-tertiary)' }}>
            ...
            <div className="timeline-format">
                <div className="column">
                    ...
                    <div className="job-descriptions">
                        <div className="job-subdescriptions">
                            <span className="job-title">SOFTWARE ENGINEER I</span><span className="company-name">@ Collins Aerospace</span>
                        </div>
                ...
                <div className="column">
                    ...
                    <div className="job-descriptions">
                        <div className="job-subdescriptions">
                            <span className="job-title">SOFTWARE ENGINEER INTERN</span><span className="company-name">@ Collins Aerospace</span>
                        </div>
                        <span className="separator">---</span>
                        <div>
                ...
                <div className="column">
                    ...
                    <div className="job-descriptions">
                        <div className="job-subdescriptions">
                            <span className="job-title">SOFTWARE ENGINEER INTERN</span><span className="company-name">@ Medtronic</span>
                        </div>
                        <span className="separator">---</span>
                        <div>
